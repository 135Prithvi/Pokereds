...
export default function Weather({ data, city }: any) {
  ...
  return (
    <div className=" mx-10 my-14 max-w-xs place-items-center sm:m-auto sm:my-16 sm:max-w-lg ">
      <a className="text-md border-gray-00 mx-2 mb-1 block rounded-lg border-4 bg-white py-5 px-5 pr-4 pl-3  text-center  font-medium shadow-xl  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 sm:block">
